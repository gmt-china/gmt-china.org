...
# 绘制中国地图
gmt pscoast -J$J -R$R -G244/243/239 -S167/194/223 -B10f5g10 -Lg85/17.5+c17.5+w800k+f+u+l'Scale' \
...
echo "SC Sea Islands" | gmt pstext -J$J -R$R -F+f10p+cBC -D0c/0.1c -N -Gwhite -O >> $PS
