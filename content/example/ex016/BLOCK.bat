...
REM ============绘制板块边界
gmt psxy CN-plate-neighbor.dat -R%R% -J%J% -W2.0p,2/138/210 -Sf1+l+t -G2/138/210 -O -K >> %PS%
REM ============绘制推断地块边界
gmt psxy CN-block-L1-deduced.dat -R%R% -J%J% -W2.0p,2/138/210,- -O -K >> %PS%
REM ============绘制二级地块边界
gmt psxy CN-block-L2.dat -R%R% -J%J% -W1.0p,orange -O -K >> %PS%
REM ============绘制一级地块边界
gmt psxy CN-block-L1.dat -R%R% -J%J% -W0.5p,2/138/210 -O -K >> %PS%
...
REM ============边界图例
echo S 0.3i f1+l+t 0.4i/0.5c 2/138/210 2.0p,2/138/210 0.7i 板块边界 > legend
echo S 0.3i - 0.5i 2/138/210 0.5p,2/138/210 0.7i  一级地块边界 >> legend
echo S 0.3i - 0.5i - 2p,2/138/210,- 0.7i  推断地块边界 >> legend
echo S 0.3i - 0.5i orange 1.0p,orange 0.7i 二级地块边界 >> legend
