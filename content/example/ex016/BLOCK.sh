...
S 0.3i f1+l+t 0.4i/0.5c 2/138/210 2.0p,2/138/210 0.7i 板块边界
S 0.3i - 0.5i 2/138/210 0.5p,2/138/210 0.7i  一级地块边界
S 0.3i - 0.5i - 2p,2/138/210,- 0.7i  推断地块边界
S 0.3i - 0.5i orange 1.0p,orange 0.7i 二级地块边界
EOF
