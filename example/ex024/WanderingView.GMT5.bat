...
REM 6.绘制行车轨迹（116.2°E,40.3°N）至（117°E,36°N）
...
REM 9. 写文字标注,用同色轮廓线显示加粗效果
echo 5.9 3.2 北京 | gmt pstext -R -J -F+f8p,STFangsong-Light--GB-EUC-H,red=0.5p,red -Gwhite@50 -D-0.3c/0.2c -O -K >> %PS%
echo 3.95 2.2 济宁 | gmt pstext -R -J -F+f8p,STFangsong-Light--GB-EUC-H,red=0.5p,red -Gwhite@50 -D-0.3c/0.2c -O -K >> %PS%
