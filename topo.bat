...
echo H 10 4 MAGNITUDE >>legend.txt
echo C 0/0/255 >>legend.txt
echo S 0.05i c 0.20 blue 0.25p,blue 0.18i 5~5.9 >>legend.txt
echo C 255/0/0 >>legend.txt
echo S 0.05i c 0.24 red 0.25p,red 0.18i 6~6.9 >>legend.txt
echo C 0/255/0 >>legend.txt
echo S 0.05i a 0.42 green 0.25p,black 0.18i 7~7.9 >>legend.txt
echo C purple >>legend.txt
echo S 0.05i a 0.48 purple 0.25p,black 0.18i 8~8.9 >>legend.txt
